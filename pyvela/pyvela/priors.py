...
DEFAULT_PRIOR_DISTS = {
    ...
    "DECJ": jl.LongitudePriorDistribution(),  # sin(DECJ) is uniformly distributed in [-1,1].
    "ELONG": jl.Uniform(0, 2 * jl.pi),  # duh!
    "ELAT": jl.LongitudePriorDistribution(),  # sin(ELAT) is uniformly distributed in [-1,1].
}
