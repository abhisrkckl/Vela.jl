...
- `SPNTA.prior_bounds`, `SPNTA.draw_from_prior()`, `SPNTA.lnprior_vectorized()`, and `SPNTA.lnlike_vectorized()`.
- Option to save the Bayesian evidence in `SPNTA.save_results()`
## Changed
