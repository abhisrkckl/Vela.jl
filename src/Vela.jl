...
include("model/gp_noise/gp_noise.jl")
include("model/gp_noise/powerlaw_red_noise.jl")
include("model/gp_noise/powerlaw_dispersion_noise.jl")
include("model/gp_noise/powerlaw_chromatic_noise.jl")
include("model/gp_noise/powerlaw_solarwind_noise.jl")
