...
gp_ampl_params(::PowerlawRedNoiseGP) = (:PLREDSIN_, :PLREDCOS_)
...
gp_ampl_params(::PowerlawDispersionNoiseGP) = (:PLDMSIN_, :PLDMCOS_)
...
gp_ampl_params(::PowerlawChromaticNoiseGP) = (:PLCHROMSIN_, :PLCHROMCOS_)
